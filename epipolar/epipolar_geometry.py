...
image_left_name = "face_left.jpg"
image_right_name = "face_right.jpg"
feature_type_name = "sift"
...
if __name__=='__main__':
	...
	img_left = cv2.imread(image_left_name, 0) # Left image
	img_right = cv2.imread(image_right_name,0) # Right image
